...
public class CoreServicePacket implements INetworkPacket<ServerboundCustomPayloadPacket, ClientboundCustomPayloadPacket>
{
	...
	{
		public static final ResourceLocation ID = PACKET_ID;
...
//		public static Payload fromByteBuf(FriendlyByteBuf buffer)
//		{
//			return new Payload(new CoreServicePacket(buffer));
//		}

		public Payload fromByteBuf(FriendlyByteBuf buffer)
		{
			return new Payload(new CoreServicePacket(buffer));
		}
